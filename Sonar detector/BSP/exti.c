...
{	
  ...
  //选择中断线路14,15,
  EXTI_InitStructure.EXTI_Line = KEY1_BUTTON_EXTI_LINE | KEY2_BUTTON_EXTI_LINE ; 
  //设置为中断请求触发模式
...
void Nvic_Config()
{
  ...
  NVIC_InitStructure.NVIC_IRQChannel = KEY1_BUTTON_EXTI_IRQn|KEY2_BUTTON_EXTI_IRQn;//配置选中的中断向量,指定中断源
